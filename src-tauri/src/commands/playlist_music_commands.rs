...
#[tauri::command]
pub fn insert_song_into_playlist(playlist_id_arg: i32, audio_id_arg: i32) -> Result<(), String> {
  use crate::schema::playlist_audio::dsl::*;

  let mut connection: SqliteConnection = establish_connection();

  let new_playlist_music: NewPlaylistAudio= NewPlaylistAudio{
...
#[tauri::command]
pub fn destroy_song_from_playlist(playlist_id_arg: i32, audio_id_arg: i32) -> Result<(), String> {
  use crate::schema::playlist_audio::dsl::*;
